...
return new class extends Migration {
    public function up(): void
    {
        ...
        Schema::create('curriculum_matrices', function (Blueprint $table) {
            ...
            $table->enum('status', ['Atual', 'Ativa', 'Inativa'])->default('Ativa');
        ...
        Schema::create('subjects', function (Blueprint $table) {
            ...
            $table->unsignedSmallInteger('presential_hours')->default(0);
            $table->unsignedSmallInteger('online_hours')->default(0);
            $table->unsignedSmallInteger('practice_hours')->default(0);
            $table->unsignedSmallInteger('extension_hours')->default(0);
            $table->timestamps();
        });
        Schema::create('curriculum_subject', function (Blueprint $table) {
            $table->id();
            $table->foreignId('curriculum_matrix_id')->constrained()->cascadeOnDelete();
            $table->foreignId('subject_id')->constrained()->cascadeOnDelete();
            $table->unsignedTinyInteger('period');
            $table->unsignedTinyInteger('sequence')->default(1);
            $table->unique(['curriculum_matrix_id', 'subject_id']);
        });
        ...
        Schema::create('professor_availabilities', function (Blueprint $table) {
            ...
            $table->time('ends_at');
            $table->enum('preference', ['available', 'preferred', 'unavailable'])->default('available');
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists('curriculum_matrices');
