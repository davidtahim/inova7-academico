                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('users.store') }}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <label for="registration_number" class="form-label fw-semibold">Matrícula / RA
                                        (Opcional)</label>
                                    <input type="text"
                                        class="form-control @error('registration_number') is-invalid @enderror"
                                        id="registration_number" name="registration_number"
                                        value="{{ old('registration_number') }}" placeholder="Ex: 56015806">
                            ...
                            <div class="row mb-4 align-items-end">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select @error('role') is-invalid @enderror" id="role"
                                        name="role" required>
                                        <option value="" disabled {{ old('role') ? '' : 'selected' }}>Selecione o
                                            Perfil</option>
                                ...
                                <div class="col-md-6 pb-2">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="is_active" name="is_active"
                                            value="1" checked>
                                        <label class="form-check-label fw-semibold" for="is_active">Permitir login
                                            imediatamente</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    @error('password')
                                        <div class="form-text text-danger">As senhas devem coincidir.</div>
                                    @enderror
                                </div>
                            </div>
